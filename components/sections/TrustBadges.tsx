...
function NextjsIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
      ...
      <text x="7" y="16.5" fontSize="10" fill="currentColor" stroke="none" fontWeight="700" fontFamily="sans-serif">N</text>
    </svg>
  );
}
...
function TypeScriptIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
      <rect x="2" y="2" width="20" height="20" rx="4" />
      <text x="4.5" y="16.5" fontSize="8" fill="currentColor" stroke="none" fontWeight="700" fontFamily="sans-serif">TS</text>
    </svg>
  );
}
    ...
    >
      <Container>
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <p className="text-[11px] uppercase tracking-widest text-[#71717A] flex-shrink-0">
            Trusted infrastructure &amp; partnerships
          </p>

          <StaggerGrid className="flex items-center gap-6 flex-wrap" stagger={0.08}>
            {badges.map(({ label, Icon }) => (
              <div key={label} className="flex flex-col items-center gap-1.5 text-[#71717A]">
                <Icon />
          ...
          <div className="flex flex-col items-end gap-0.5 flex-shrink-0">
            ...
            <span className="text-[11px] text-[#71717A]">Verified client reviews</span>
          </div>
        </div>
      </Container>
    </section>
